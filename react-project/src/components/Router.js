		...
		<BrowserRouter basename={process.env.PUBLIC_URL}>
			<Routes>
				<Route path='/' element={(<Layout />)}>
					...
					<Route path='coupon' element={(<Coupon coupon={coupon} rec={coupons.slice(2, 6)} setCoupon={setCoupon} deleteCoupon={options.deleteCoupon} editCoupon={options.editCoupon} />)} />
